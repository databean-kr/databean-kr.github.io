   ...
   function avia_scroll_top_fade()
   {
    ...
    $.AviaTooltip.prototype =
    {
        ...
        display_tooltip: function(e)
        {
			...
			if(position == "top" ||혻position == "bottom")
			{
				switch(align)
				{
...
// requestAnimationFrame polyfill by Erik M철ller. fixes from Paul Irish and Tino Zijdel. can be removed if IE9 is no longer supported or all parallax scripts are gone MIT license
